...
import { ProductTableData, AccountTableData, BrandTableData, OrderTableData, BlogTableData } from '@/types'
import { Table, TableColumnsType } from 'antd'

type TableDataType = AccountTableData | ProductTableData | BrandTableData | OrderTableData | BlogTableData
