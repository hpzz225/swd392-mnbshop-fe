...
import AddPromotion from '@/features/manager-feature/promotion-mng/add-promotion'
          ...
          <div className="flex flex-col gap-4">
            <div className="flex items-center gap-2">
              <ConfigAntdTheme theme={GreenButtonStyle}>
                <Popup width={500} type="form" title={POPUP_TITLE.ADD_PROMOTION} content={<AddPromotion />}>
